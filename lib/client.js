		...
		function WorkspaceBrowser({ ctx, identity, sessions, onChanged }) {
		  ...
		  return (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%", overflow: "hidden", padding: "0 4px" }, children: [
		    ...
		    (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 4, marginBottom: 8 }, children: [
		      ...
		      (0, import_jsx_runtime.jsx)("button", { onClick: createWorkspace, style: primaryBtnStyle, children: "\uFF0B" })
		    ] }),
		    (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, overflowY: "auto", minHeight: 0 }, children: [
		      ...
		      !loadingW && shown.length === 0 && (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 13, padding: "12px 8px", textAlign: "center" }, children: "\u6682\u65E0\u5DE5\u4F5C\u533A\uFF0C\u8BF7\u5728\u4E0A\u65B9\u65B0\u5EFA" })
		    ] })
		  ] });
		}
		function apply(ctx) {
