	...
	factory: (require) => {
		...
		function DirectoryPicker({ ctx, open, initialPath, onPick, onCancel }) {
		  ...
		  return (0, import_jsx_runtime.jsxs)(import_dsh_client_ui_primitives.Modal, {
		    ...
		    children: (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8, minHeight: 280 }, children: [
		      // 面包屑
		      (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 2, flexWrap: "wrap", padding: "2px 0" }, children: [
		        ...crumbs.map((c, i) => (0, import_jsx_runtime.jsxs)(React.Fragment, { key: c.path, children: [
		          i > 0 && (0, import_jsx_runtime.jsx)("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 12, margin: "0 2px" }, children: "/" }),
		          (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: () => load(c.path), style: { background: "transparent", border: "none", cursor: "pointer", color: "var(--dsw-alias-label-secondary)", fontSize: 13, padding: 2, maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: c.name })
		        ] }))
		      ] }),
		      // 当前路径
		      listing && (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 12, fontFamily: "var(--ds-font-family-code, monospace)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: listing.path }),
		      // 子目录列表
		      (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, overflowY: "auto", minHeight: 160, border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 8, padding: 4 }, children: [
		        entries.length > 0 ? entries.map((e) => (0, import_jsx_runtime.jsx)("button", {
		          type: "button",
		          key: e.path,
		          onClick: () => load(e.path),
		          ...
		          children: (0, import_jsx_runtime.jsxs)(React.Fragment, { children: [(0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconFolderClose16, {}), (0, import_jsx_runtime.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: e.name })] })
		        })) : (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 12, padding: "16px", textAlign: "center" }, children: "\uFF08\u7A7A\u76EE\u5F55\uFF09" })
		      ] }),
		      error && (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-state-error-primary)", fontSize: 12 }, children: error })
		    ] }),
		    footer: (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, width: "100%" }, children: [
		      // 新建文件夹
		      newFolderOpen ? (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4, flex: 1 }, children: [
		        (0, import_jsx_runtime.jsx)("input", { value: newName, autoFocus: true, onChange: (e) => setNewName(e.target.value), onKeyDown: (e) => {
		          if (e.key === "Enter") createFolder();
		          if (e.key === "Escape") setNewFolderOpen(false);
		        }, placeholder: "\u65B0\u5EFA\u6587\u4EF6\u5939\u540D\u79F0", style: { ...inputStyle, height: 32 } }),
		        (0, import_jsx_runtime.jsx)("button", { onClick: createFolder, disabled: creating, style: primaryBtnStyle, children: "\u521B\u5EFA" })
		      ] }) : (0, import_jsx_runtime.jsx)("button", { onClick: () => setNewFolderOpen(true), style: btnStyle, children: "\u65B0\u5EFA\u6587\u4EF6\u5939" }),
		      (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
		      (0, import_jsx_runtime.jsx)("button", { onClick: onCancel, style: btnStyle, children: "\u53D6\u6D88" }),
		      (0, import_jsx_runtime.jsx)("button", { onClick: () => listing && onPick(listing.path), disabled: !listing, style: primaryBtnStyle, children: "\u9009\u62E9\u6B64\u76EE\u5F55" })
		    ] })
		  });
		}
