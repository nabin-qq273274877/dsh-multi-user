window.__ModuleLoader__.load({
	...
	factory: (require) => {
		    ...
		    (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", width: "100%" }, children: [
		      (0, import_jsx_runtime.jsxs)("button", {
		        ...
		        children: [
		          ...
		          (0, import_jsx_runtime.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: workspace.name })
		        ]
		      }),
		...
		function WorkspaceBrowser({ ctx, identity, sessions, onChanged }) {
		  ...
		  const reload = React.useCallback(() => {
		    ...
		    setLoadingW(true);
		    fetch("/api/mu/me/workspaces", { credentials: "same-origin" }).then((r) => r.ok ? r.json() : Promise.reject(new Error("list failed"))).then((data) => {
		  ...
		  return (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%", overflow: "hidden", padding: "0 4px" }, children: [
		    ...
		    (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4, height: 36, margin: "2px -4px 4px", padding: "0 4px" }, children: [
		      (0, import_jsx_runtime.jsx)("span", { style: { flex: "none", maxWidth: "45%", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 12, color: "var(--dsw-alias-label-tertiary)", lineHeight: "20px" }, children: "\u5DE5\u4F5C\u533A" }),
		      // 搜索（点击展开）
		      searchExpanded ? (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, display: "flex", alignItems: "center", gap: 4, border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 10, height: 30, padding: "0 4px 0 8px" }, children: [
		      ...
		      ] }) : (0, import_jsx_runtime.jsx)("button", { type: "button", title: "\u641C\u7D22", onClick: () => setSearchExpanded(true), style: iconBtnStyle, children: "\u2315" }),
		      // 视图（分组/排序；专属目录扫描下为占位，保留对齐原生三按钮）
		      (0, import_jsx_runtime.jsx)("button", { type: "button", title: "\u89C6\u56FE", onClick: () => reload(), style: iconBtnStyle, children: "\u2261" }),
		      // 添加（点击展开输入框）
		      (0, import_jsx_runtime.jsx)("button", { type: "button", title: "\u65B0\u5EFA\u5DE5\u4F5C\u533A", onClick: () => {
		        setAdding((v) => !v);
		        setAddError(null);
		      }, style: iconBtnStyle, children: "\uFF0B" })
		    ] }),
		    // 添加工作区的内联输入框
		    adding && (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4, marginBottom: 8 }, children: [
		      (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 4 }, children: [
		        (0, import_jsx_runtime.jsx)("input", {
		          value: newName,
		          autoFocus: true,
		        ...
		        (0, import_jsx_runtime.jsx)("button", { onClick: createWorkspace, style: primaryBtnStyle, children: "\u521B\u5EFA" })
		      ] }),
		      addError && (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-state-error-primary)", fontSize: 12 }, children: addError })
		    ] }),
		    (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, overflowY: "auto", minHeight: 0 }, children: [
		      loadingW ? (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 13, padding: "12px 8px", textAlign: "center" }, children: "\u52A0\u8F7D\u4E2D\u2026" }) : shown.map((w) => (0, import_jsx_runtime.jsx)(WorkspaceItem, {
		        key: w.path,
		        workspace: w,
		        sessions,
		        onOpen: (id) => {
		      ...
		      !loadingW && shown.length === 0 && (0, import_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 13, padding: "12px 8px", textAlign: "center" }, children: "\u6682\u65E0\u5DE5\u4F5C\u533A\uFF0C\u70B9\u51FB\u53F3\u4E0A\u89D2 \uFF0B \u65B0\u5EFA" })
		    ] })
		  ] });
		}
		function apply(ctx) {
