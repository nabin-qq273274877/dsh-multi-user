window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function WorkspaceBrowser({ ctx, identity, sessions, renderSlot }) {
		  ...
		  const flowOwner = {
		    ...
		    onPicked: (path) => {
		      ...
		      ctx.workspaces.create({ path }).then(() => {
		        closeAddFlow();
		      }).catch((err) => {
		  ...
		  return (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%", overflow: "hidden", padding: "0 4px" }, children: [
		    ...
		    (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4, height: 36, margin: "2px -4px 4px", padding: "0 4px" }, children: [
		      ...
		      !searchExpanded && (0, import_jsx_runtime.jsx)("button", { ref: addBtnRef, type: "button", title: "\u65B0\u5EFA\u5DE5\u4F5C\u533A", onClick: openAddFlow, style: iconBtnStyle, children: (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconProjectAddOutline16, { size: 16 }) })
		    ] }),
